package com.example.hi.infokost;
...
import com.example.hi.infokost.app.AppController;
import com.example.hi.infokost.data.Data;
import com.example.hi.infokost.util.Server;
import com.example.hi.infokost.adapter.Adapter;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void DialogForm(String idx, String namax, String alamatx, String button) {
        ...
        dialogView = inflater.inflate(R.layout.form_kost, null);
        dialog.setView(dialogView);
        dialog.setCancelable(true);
        dialog.setIcon(R.mipmap.ic_launcher);
        dialog.setTitle("Form Kost");
